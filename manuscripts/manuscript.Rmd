...
the GP.   This is a best-case scenario for the parametric models because the underlying dynamics are always simuated
from one of the parametric models in the set, whereas in reality we never
...
We use inverse Gamma priors on both the lengthscale $\ell$ and $\sigma$, of the form

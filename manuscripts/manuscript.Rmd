...
effects [@Sugeno2013a], estimate the maximum reproductive
rate [@Sugeno2013b], determine temporal variation in food
...
parameters (See appendix Tables S1-S3; R code
...
```{r FigureS1, fig.cap = "Traces from the MCMC estimates of the GP model show reasonable mixing (no trend) and sampling rejection rate (no piecewise jumps)", dependson="plot-options"}

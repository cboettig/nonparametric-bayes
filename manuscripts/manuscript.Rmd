...
$X_{\textrm obs}(t), X_{\textrm obs}(t+1)$ for $t \in [1,2, ..., T]$

Under the GP, a finite sample of these predictions at $n$ points into the future, $X_{\textrm p}(\tau)$ for $\tau in [T+1, T+2, ..., T+n]$, is simply given by a multivariate normal ($\mathcal{N}$):
...
simpler models therefore fit just as well and tend to be selected more often than complex 
...
dictated by the GP balances this uncertainty against

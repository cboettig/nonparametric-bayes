...
opts_chunk$set(tidy=FALSE, warning=FALSE, message=FALSE, cache=TRUE, comment=NA,
               fig.width=6, fig.height=4, cache.path="myers/")
...
```{r gp-opt, dependson="assemble-models"}
MaxT = 1000
...
```{r mle-opt, dependson="assemble-models"}
...
```{r allen-opt, dependson="assemble-models"}
...
```{r ricker-opt, dependson="assemble-models"}
...
```{r myers-opt, dependson="assemble-models"}

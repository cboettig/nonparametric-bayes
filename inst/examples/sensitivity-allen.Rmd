...
Replicate data-sets from the same model, varying both model parameters and data simulation seed
...
Compare over `r length(seed)` simulation configurations with different parameters and different training data, the GP does consistently well.  Only one case has relatively poor outcomes.  

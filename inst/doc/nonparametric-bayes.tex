...
\NormalTok{step_ahead <-}\StringTok{ }\NormalTok{function(x, f, p)\{}
  \NormalTok{h =}\StringTok{ }\DecValTok{0}
  \NormalTok{x_predict <-}\StringTok{ }\KeywordTok{sapply}\NormalTok{(x, f, h, p)}
  \NormalTok{n <-}\StringTok{ }\KeywordTok{length}\NormalTok{(x_predict) -}\StringTok{ }\DecValTok{1}
  \NormalTok{y <-}\StringTok{ }\KeywordTok{c}\NormalTok{(x[}\DecValTok{1}\NormalTok{], x_predict[}\DecValTok{1}\NormalTok{:n])}
  \NormalTok{y}
\NormalTok{\}}
\NormalTok{step_ahead_posteriors <-}\StringTok{ }\NormalTok{function(x)\{}
\NormalTok{gp_f_at_obs <-}\StringTok{ }\KeywordTok{gp_predict}\NormalTok{(gp, x, }\DataTypeTok{burnin=}\FloatTok{1e4}\NormalTok{, }\DataTypeTok{thin=}\DecValTok{300}\NormalTok{)}
\NormalTok{df_post <-}\StringTok{ }\KeywordTok{melt}\NormalTok{(}\KeywordTok{lapply}\NormalTok{(}\KeywordTok{sample}\NormalTok{(}\DecValTok{100}\NormalTok{), }
...
\NormalTok{df_post <-}\StringTok{ }\KeywordTok{step_ahead_posteriors}\NormalTok{(x)}

\KeywordTok{ggplot}\NormalTok{(df_post) +}\StringTok{ }\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(time, stock)) +}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(time, value, }\DataTypeTok{col=}\NormalTok{variable, }\DataTypeTok{group=}\KeywordTok{interaction}\NormalTok{(L1,variable)), }\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{1}\NormalTok{) +}\StringTok{ }

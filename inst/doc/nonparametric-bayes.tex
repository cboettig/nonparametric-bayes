...
\caption{Traces from the MCMC estimate of the Ricker model}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics{figure/nonparametric-bayes-unnamed-chunk-13.pdf}
\caption{Traces from the MCMC estimates of the GP model}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{figure/nonparametric-bayes-unnamed-chunk-14.pdf}
